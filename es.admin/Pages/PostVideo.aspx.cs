...
namespace es.admin
{
    public partial class PostVideo : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            var videos = request.getNVideosVim(12);
            Debug.WriteLine("videos here");
            foreach (var x in videos.Result.Data)
            {
                Debug.WriteLine(x);
            }
            Debug.WriteLine(videos.Status.ToString(), videos.AsyncState);
